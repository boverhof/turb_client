...
class SimulationWriteTest(BaseIntegrationTestCase):
    ...
    def test_create_simulation(self):
        ...
        self.failUnlessEqual(data, open(config_path).read(), 'sinter config file does not match')

        data = tsim.main_get(['-r', 'aspenfile', name, self.config_name], func=None)
        self.failUnlessEqual(data, open(app_path).read(), 'aspen file does not match')
